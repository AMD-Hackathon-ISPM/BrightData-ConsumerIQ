      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(min(100%,11rem),1fr))] gap-3">
        ...
        <Entrance animate={animate} delay={320} transitionKey="metric-1">
          <MetricCard
            ...
            status="47 active SKUs · top 3 hold 38%"
            title="Medium"
        ...
        <Entrance animate={animate} delay={440} transitionKey="metric-2">
          <MetricCard
            label="Market Gaps"
            status="$18–24 fragrance-free niche"
            title="3 found"
            visual={<GapMarkers />}
          />
        </Entrance>
        ...
        <Entrance animate={animate} delay={920} transitionKey="panel-signals">
          <Panel title="Category Signals">
            <div className="flex flex-col">
              <SignalRow
                label="Trending ingredient"
                value={
                  <span className="inline-flex items-baseline gap-1.5">
                    Ceramide-NP <span className="text-chart-4">+44%</span>
                  </span>
                }
              />
              <SignalRow
                label="Top unmet pain point"
                value="Stinging / fragrance"
              />
              <SignalRow
                label="Claim saturation"
                value={'"Hydrating" 92% · "Barrier" 31%'}
              />
              <SignalRow
                label="Avg review score · top 10"
                value="4.3 ★ · 12K reviews"
              />
            </div>
          </Panel>
        </Entrance>
