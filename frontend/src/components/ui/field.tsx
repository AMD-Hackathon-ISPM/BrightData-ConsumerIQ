...
function FieldRow({
    ...
    return (
        <div className={cn("grid gap-2 md:grid-cols-12", alignTop ? "md:items-start" : "md:items-center")}>
            <div className={cn("col-span-5 flex flex-col space-y-1", alignTop && "pt-1")}>
                <span className="break-words text-sm text-base">
                    {label}
