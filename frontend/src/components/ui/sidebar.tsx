...
function Sidebar({
    ...
    React.useEffect(() => {
        ...
        sidebarContainer.addEventListener("wheel", handleWheel, {
            capture: true,
            passive: false,
        });
        ...
        >
            ...
            >
                <div
                    ...
                    className="flex size-full flex-col overflow-hidden overscroll-none bg-sidebar-background group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border"
                >
                    {children}
                </div>
            </div>
...
function SidebarTrigger({
    ...
    return (
        <Button
            ...
            {...props}
        >
            <IconLayoutSidebar className="size-[20px]" />
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div
            ...
            data-sidebar="header"
            className={cn(
                "flex flex-col gap-2 px-4 py-2 transition-[padding] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] motion-reduce:duration-0 group-data-[collapsible=icon]:px-2",
                className,
            )}
            {...props}
        />
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div
            ...
            data-sidebar="content"
            className={cn(
                "no-scrollbar flex min-h-0 flex-1 flex-col gap-0 overflow-auto overscroll-y-contain group-data-[collapsible=icon]:overflow-hidden",
                className,
            )}
            {...props}
        />
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div
            ...
            data-sidebar="group"
            className={cn(
                "relative flex w-full min-w-0 flex-col px-4 py-1.5 transition-[padding] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] motion-reduce:duration-0 group-data-[collapsible=icon]:px-2",
                className,
            )}
            {...props}
        />
...
function SidebarGroupLabel({
    ...
    return (
        <Comp
            ...
            className={cn(
                "flex h-8 shrink-0 items-center rounded-md px-2 text-xs text-sidebar-foreground/70 ring-sidebar-ring outline-hidden transition-[margin,opacity,transform] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] motion-reduce:duration-0 group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:translate-x-1 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
                className,
            )}
            {...props}
        />
...
function SidebarMenuButtonTooltip({
    ...
    const {
        onPointerEnter: propOnPointerEnter,
        onPointerLeave: propOnPointerLeave,
        onFocus: propOnFocus,
        onBlur: propOnBlur,
        ...restProps
    } = props;
            ...
            <PopoverAnchor asChild>
                <Comp
                    ...
                    onPointerEnter={(event) => {
                        propOnPointerEnter?.(event);
                        setOpen(true);
                    }}
                    onPointerLeave={(event) => {
                        propOnPointerLeave?.(event);
                        setOpen(false);
                    }}
                    onFocus={(event) => {
                        propOnFocus?.(event);
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
    return (
        <ul
            ...
            className={cn(
                "ml-4 mr-0 flex min-w-0 translate-x-px flex-col gap-1.5 border-l-[1.5px] border-sidebar-border py-1 group-data-[collapsible=icon]:hidden",
                className,
            )}
            {...props}
        />
