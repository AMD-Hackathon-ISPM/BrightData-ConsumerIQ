...
def runPersonaDecodeTask(formData: dict) -> dict[str, Any]:
    ...
    prompt = (
        ...
        'AND a TAM/SAM/SOM market sizing for this product.\n\n'
        ...
        f'Market Signals:\n{signalContext}\n\n'
        'For TAM/SAM/SOM: TAM is the total global category market in USD/year. '
        'SAM is the slice this product could realistically serve given its '
        'country/region/segment focus. SOM is what this product could capture in '
        '24 months with reasonable execution. Use real category market-size '
        'estimates (e.g. global skincare ~$180B, US sleep aids ~$5B). Provide '
        'value, percentage of parent, and a one-sentence rationale for each.\n\n'
        ...
        '"tamSamSom":{'
        '"tam":{"value":"$XB","percentOfParent":100,"description":"Total category, global"},'
        '"sam":{"value":"$XB","percentOfParent":number,"description":"Reachable slice in target country/segment"},'
        '"som":{"value":"$XXM","percentOfParent":number,"description":"Capturable in 24 months"},'
        '"methodology":"One paragraph on how the numbers were derived from category data + this product\'s fit"'
        '}}\n\n'
        'JSON:'
    )
